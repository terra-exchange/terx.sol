...
/**
   ...
   With a 5% LIQ fee, holders will be rewarded
   Let's get this coin to 1000x for the future!
...
contract TerraExchange is Context, IERC20, Ownable {
    ...
    string private _name = "TerraExchange";
    string private _symbol = "TERX";
